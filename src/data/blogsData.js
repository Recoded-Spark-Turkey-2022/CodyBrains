// This file contains the data for the blogs' section of the home page.
...
const blogsData = [
  {
    ...
    text: 'Leaving ones home country and immigrating to a new place can be a challenging and emotional experience, especially for refugees who may be fleeing conflict, persecution, or other difficult circumstances. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptatem, laborum! Sed, consequatur cum neque nam consectetur possimus delectus sit quidem provident iure corrupti ut tenetur, architecto doloremque necessitatibus dolorem repellat velit consequuntur eaque qui molestias sint? Reprehenderit corrupti sint laboriosam asperiores quae. Eius corporis, sunt porro ad totam repellendus tempora! Excepturi praesentium nisi maiores nobis sit consequatur omnis quas similique eius velit error exercitationem, fugiat iure. Harum a optio doloremque eveniet quaerat magni ex omnis, esse et possimus reprehenderit soluta, delectus necessitatibus voluptate eum autem veniam laborum illum minus provident voluptates cupiditate? Nihil maiores qui, velit consectetur error assumenda doloremque.',
    headerPhoto: coverImage,
    author: { name: 'Tahsin', photo: userAvatar },
  },
  {
    id: 2,
    date: Timestamp.fromDate(new Date('2021-03-01')),
    ...
    avatar: userAvatar,
    headerPhoto: coverImage,
    author: { name: 'nour', photo: userAvatar },
  },
  {
    id: 3,
    date: Timestamp.fromDate(new Date('2021-03-01')),
    ...
    avatar: userAvatar,
    headerPhoto: coverImage,
    author: { name: 'alparslan', photo: userAvatar },
  },
  {
    id: 4,
    date: Timestamp.fromDate(new Date('2021-03-01')),
    ...
    avatar: userAvatar,
    headerPhoto: coverImage,
    author: { name: 'ahmad', photo: userAvatar },
  },
];
